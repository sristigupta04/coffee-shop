...
<div className="p-5">
    ...
    <p className=" mt-3 text-xl font-bold text-[#9a4f24]">
    ...
    <button onClick={decrease} className=" flex w-10 h-10  items-center justify-center 
    rounded-full bg-[#9a4f24] text-lg tex-white hover:bg-[#7a3620] transition-colors duration-300"> -</button>
